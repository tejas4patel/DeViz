import { Link, Node, SevenKey, SevenPack, Scene04Row, Scene08Row } from './storyTypes';

export const sevenOrder: { key: SevenKey; label: string }[] = [
  { key: 'who', label: 'Who' },
  { key: 'what', label: 'What' },
  { key: 'when', label: 'When' },
...
export function makeSevenPack(base: Partial<SevenPack>): SevenPack {
...
export const scene01Links: Link[] = [
...
export const scene04Rows: Scene04Row[] = [
...
export const scene08Rows: Scene08Row[] = [
...
export const scenePlaceholderData = {
  message: 'Data for this scene is not yet available.',
};
